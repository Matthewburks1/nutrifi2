...
class Body extends Component {
	...
	@computed get business() {
		return this.permissions.filter(tool => tool.category === 'Weight Loss Calculator')
	}
	...
	@computed get content() {
		return this.permissions.filter(tool => tool.category === 'Nutrition')
	}

	@computed get programming() {
		return this.permissions.filter(tool => tool.category === 'NUTRIFI')
	}
	...
	return (
		...
		<>
			...
			{this.business.length ? <>
				<Title title="Weight loss Calculator" />
				<Grid>
